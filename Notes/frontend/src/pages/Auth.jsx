...
// Pills shown on mobile instead of feature cards
const mobilePills = [
  { icon: "🎁", label: "50 free credits" },
  { icon: "📘", label: "Exam notes" },
  { icon: "📊", label: "Charts & graphs" },
  { icon: "⬇️", label: "PDF export" },
  { icon: "⚡", label: "Instant access" },
  { icon: "📁", label: "Project notes" },
]
      ...
      {isMobile ? (
        <div style={{
          ...
          <motion.div
            ...
            style={{ display: "flex", alignItems: "center", gap: 10, paddingTop: 48, marginBottom: 40 }}
          >
            <div style={{
              width: 34, height: 34, background: "#1a1714", borderRadius: 9,
              display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17,
            }}>📝</div>
            <span style={{ fontFamily: "'Lora', serif", fontWeight: 700, fontSize: 20, color: "#1a1714" }}>
          ...
          <div style={{ position: "relative", width: "100%", height: 90, marginBottom: 16 }}>
            ...
            >
              <span style={{ fontSize: 11, color: "#b07d3a", fontWeight: 600, display: "block", marginBottom: 3 }}>📌 Exam tip</span>
          ...
          <motion.div
            ...
            style={{
              ...
              padding: "5px 14px 5px 8px", marginBottom: 20,
            }}
          >
            <span style={{ fontSize: 14 }}>🎓</span>
            <span style={{ fontSize: 12, fontWeight: 500, color: "#b07d3a", fontFamily: "'Lora', serif" }}>
          ...
          >
            Unlock Smart{" "}
            <span style={{
              background: "linear-gradient(120deg, #b07d3a, #d4a85a)",
          ...
          <motion.p
            ...
            style={{
              fontSize: 14, color: "#7a7570", lineHeight: 1.65,
              textAlign: "center", maxWidth: 300, marginBottom: 32,
            }}
          >
            Generate exam-ready notes, charts & PDFs — powered by AI.
          </motion.p>
          ...
          {error && (
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}
              style={{ fontSize: 12, color: "#c0392b", marginBottom: 12, textAlign: "center" }}>
              {error}
            </motion.p>
          )}
          ...
          <motion.div
            ...
            style={{
              ...
              maxWidth: 340, marginTop: 24,
            }}
          >
            {mobilePills.map(({ icon, label }, i) => (
              <motion.div
                key={label}
          ...
          <motion.p
            ...
            style={{ fontSize: 11, color: "#b0aba4", marginTop: 28, textAlign: "center" }}
          >
