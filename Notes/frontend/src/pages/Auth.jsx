    ...
    <div style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          }}>ExamNote <span style={{ color: "#b07d3a" }}>AI</span></span>
        </div>
        <p style={{
          fontSize: 13,
          color: "#a09b94",
      ...
      <main style={{
        ...
        >
          <motion.div variants={fadeUp} style={{
            ...
            <span style={{
              ...
              color: "#b07d3a",
              fontFamily: "'Lora', serif",
            }}>Start free — 50 credits included</span>
          </motion.div>
          ...
          <motion.p variants={fadeUp} style={{
            ...
            Generate exam-ready notes, project docs, charts & graphs — 
            then download clean PDFs instantly. All powered by AI.
          </motion.p>

          {/* Google Button */}
          <motion.button
            variants={fadeUp}
            whileHover={{ scale: 1.02, boxShadow: "0 12px 40px rgba(0,0,0,0.14)" }}
            whileTap={{ scale: 0.98 }}
            style={{
              display: "flex",
              alignItems: "center",
        ...
        <div style={{ position: "relative" }}>
          ...
          <FloatingNote
            delay={0.6}
            style={{ top: -24, right: -16, transform: "rotate(2deg)", zIndex: 2 }}
          >
          ...
          <FloatingNote
            delay={0.9}
            style={{ bottom: -20, left: -20, transform: "rotate(-1.5deg)", zIndex: 2 }}
          >
